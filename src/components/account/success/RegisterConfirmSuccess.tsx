...
export const RegisterConfirmSuccess: React.StatelessComponent<IRegisterConfirmSuccessProps> = (props: IRegisterConfirmSuccessProps) => {
...
RegisterConfirmSuccess.displayName = "RegisterConfirmSuccess";